...
#+END_SRC
** Dubious hacks
This is where I put any purported "performance" code, for which I have neither
evidence supporting the supposed benefit, nor reason to doubt it.
...
#+BEGIN_SRC emacs-lisp
  (use-package copilot
    ...
    :config (defun r/copilot-mode-maybe ()

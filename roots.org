...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package php-ts-mode
    ...
    (defun r/php-test-current-file ()
      (interactive)
      (let* ((default-directory (r/project-root))
             (file (r/project-relative-path))
             (command (funcall r/php-test-command-function file)))
        (r/ghostel-shell-command command)))

    (defun r/php-test-at-point ()
      (interactive)
      (let* ((default-directory (r/project-root))
             (command (funcall r/php-test-at-point-command-function)))
        (r/ghostel-shell-command command)))

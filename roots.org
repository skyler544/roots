...
#+BEGIN_SRC emacs-lisp
  (use-package emacs
    ...
    (defun r/run-idly (func seconds)
      "Run the no-arg `func' after `seconds' of idle time."
      (run-with-idle-timer
       seconds nil func))
    ...
    (defun r/remove-background (face)
      "Set the `:background' attribute of `face' to `unspecified'."
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package diredfl
    :hook ((after-init . diredfl-global-mode)
           (dired-mode . r/diredfl-face-override))
    :config
    (defun r/diredfl-face-override ()
      (dolist (face (r/face-filter "^diredfl-"))
        (r/remove-background face))))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package apheleia
    ...
    :config (add-to-list 'apheleia-mode-alist '(nxml-mode . xmllint)))

    ...
    (defun r/treesit-auto-setup ()
      ...
      (setq treesit-auto-langs
            '( bash c cpp css dockerfile html java javascript json vue
               php phpdoc jsdoc lua make python toml tsx typescript yaml))
...
#+BEGIN_SRC emacs-lisp
  (use-package magit
    ...
    (magit-blame-styles '((headings (heading-format . "%-20a %C %s\n")))))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package eglot-fsharp :demand
    :custom (eglot-fsharp-server-install-dir
             (expand-file-name "~/.cache/fsls/")))
#+END_SRC
* UI
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package auto-dark
    ...
    :custom
    (auto-dark-dark-theme 'gruvbox-dark-hard)

...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package composable
    :hook ((after-init . composable-mode)
           (after-init . composable-mark-mode))
    :config (setq composable-mode-line-color nil))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package emacs
    ...
    (defun r/light-mode ()
      ...
      (setq modus-themes-org-agenda (quote ((header-block . (no-scale)))))

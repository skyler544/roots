...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package web-mode
    ...
    (setq auto-mode-alist
          (cons '("\\.blade\\.php\\'" . web-mode)
                (assoc-delete-all "\\.blade\\.php\\'"
                                  auto-mode-alist))))
#+END_SRC
*** Hacky fix for editing in php-ts-mode in heredoc/nowdoc

#+BEGIN_SRC emacs-lisp
  (use-package php-ts-mode
    :hook (php-ts-mode . r/fix-janky-php-input)
    :config
    (defun r/php-ts--in-heredoc-body-p ()
      "Check if point is inside a here/now doc."
    ...
    (defun r/php-ts--inhibit-electric-indent-in-heredoc (_char)
      "No electric indent inside here/now doc, it's broken as of 07.05.2026"
      (when (r/php-ts--in-heredoc-body-p)
        'no-indent))

    (defun r/php-ts-newline-dwim ()
      (interactive)
      (if (r/php-ts--in-heredoc-body-p)
          (let ((indent (current-indentation)))
            ;; manually indents the "right amount" to work around busted behavior
            (newline)
            (indent-to indent))
        (call-interactively #'newline)))

    (defun r/fix-janky-php-input ()
          "No electric indent and work around RET inside here/now doc, it's broken as of 07.05.2026"
      (add-hook 'electric-indent-functions
                #'r/php-ts--inhibit-electric-indent-in-heredoc
                nil t)
...
#+BEGIN_SRC emacs-lisp
  (use-package dash-docs
    ...
    (setq dash-docs-common-docsets '("PHP" "PHPUnit" "Laravel" "VueJS_(Composition)"))
    (setq dash-docs-enable-debugging nil)
    (setq dash-docs-browser-func 'eww))

  (use-package consult-dash :after dash-docs
    :config

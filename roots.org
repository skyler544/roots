...
#+BEGIN_SRC emacs-lisp
  ...
  (defvar *r/agenda-files* `(,(concat *r/org-directory* "tasks.org")
                             ,(concat *r/org-directory* "life.org")))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (setq org-default-notes-file (concat org-directory "inbox/inbox.org"))
    ...
    (setq org-agenda-files *r/agenda-files*)

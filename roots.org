  ...
  (use-package compile-angel :demand t
    ...
    (mapc (lambda (file)
          ...
          '("/usr/share/emacs/30.1/etc/themes/modus-vivendi-theme.el"
            ...
            "init.el"
            "local-config.el"
            "var/bookmark-default.el"
            "var/custom.el"
            "var/project-list.el"
            "var/recentf-save.el"
            "var/save-place.el"
            "var/savehist.el"
            "/opt/homebrew/Cellar/emacs-plus@30/30.2/share/emacs/30.2/etc/themes/modus-vivendi-theme.el"))
...
#+BEGIN_SRC emacs-lisp
  (use-package emacs
    ...
    (add-to-list 'display-buffer-alist
                 '("magit:\\|*help\\|*shell\\|*Proced\\|*Copilot"
...
#+BEGIN_SRC emacs-lisp
  (use-package markdown-mode
    ...
    :bind ((:map markdown-mode-map
                 ("C-c mv" . r/markdown-toggle-view-mode))
    ...
    :config (defun r/markdown-toggle-view-mode ()
              (interactive)
              (cond ((eq major-mode 'markdown-mode) (markdown-view-mode))
